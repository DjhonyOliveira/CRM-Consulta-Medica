            ...
            <div>
                <div id="draggableModal" 
                    ...
                    <div id="modalHeader" class="cursor-move flex justify-between items-center px-4 py-3 border-b bg-gray-100 rounded-t-xl">
                        <h2 class="text-base font-semibold">Deletar Especialidade</h2>
                        <button
                        ...
                        <div class="px-4 py-4">
                            ...
                            <div class="px-4 pb-4">
                                <p class="text-sm text-gray-700 mb-3">
                                    Tem certeza que deseja <span class="font-semibold text-red-600">deletar esta especialidade</span>? Esta ação não poderá ser desfeita.
                                </p>
                                <button type="submit"
